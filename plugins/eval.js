...
izumi({pattern: '> ?(.*)', fromMe: mode, desc: 'Run js code (evel)', type: 'misc'}, async (message, match, client) => {return});
izumi({on: 'text', fromMe: mode, desc: 'Run js code (evel)', type: 'misc'}, async (message, match, client) => {
...
izumi({on:'text', fromMe: mode}, async (message, match, client) => {
if (message.message.startsWith("$")) {
var m = message
